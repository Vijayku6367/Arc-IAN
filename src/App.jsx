...
function App() {
  ...
  // Background click se menu close
  useEffect(() => {
  ...
  const connectWallet = async () => {
    try {
      if (window.ethereum) {
        ...
        alert('🔧 Demo Mode Activated\n\nMetaMask not detected. You can explore features in demo mode.');
      }
    } catch (error) {
      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Create invisible accounts, send gasless transactions and experience complete privacy on the blockchain with Arc IAN.
          </p>
          <div className="hero-actions">
            ...
            <button className="cta-button secondary" onClick={() => handleNavClick(PAGES.FEATURES)}>
              📖 Learn More
            </button>
          </div>
    ...
    <div className="contact-page">
      ...
      <div className="contact-content">
        <div className="contact-info">
          <div className="contact-item" onClick={() => window.open('mailto:vijaykumarswami2005@gmail.com')}>
            <div className="contact-icon">📧</div>
            <div>
              <h3>Email Us</h3>
              <p>vijaykumarswami2005@gmail.com</p>
            </div>
          </div>
          
          <div className="contact-item" onClick={() => window.open('https://github.com/Vijayku6367')}>
            <div className="contact-icon">🐙</div>
            <div>
              <h3>GitHub</h3>
              <p>github.com/Vijayku6367</p>
            </div>
          </div>
          
          <div className="contact-item" onClick={() => window.open('https://twitter.com/Vijayeth_')}>
            <div className="contact-icon">🐦</div>
            <div>
              <h3>Twitter</h3>
              <p>@Vijayeth_</p>
          ...
          <div className="contact-item" onClick={() => window.open('https://wa.me/916367487223')}>
            <div className="contact-icon">📱</div>
            <div>
              <h3>WhatsApp</h3>
              <p>+91 6367487223</p>
